function mascaraCEP(cep){
	...
	return mascaraCampo(cep, '00.000-000', event);
}
...
function mascaraTelefone(tel){  
	...
	return mascaraCampo(tel, '(00) 0000-0000', event);
}
...
function mascaraCelular(cel){
	...
	return mascaraCampo(cel, '(00) 00000-0000', event);
}
...
function mascaraCPF(cpf){
	...
	return mascaraCampo(cpf, '000.000.000-00', event);
}
...
function mascaraCNPJ(cnpj){
    ...
    return mascaraCampo(cnpj, '00.000.000/0000-00', event);
}
...
function mascaraCampo(campo, mascara, evento) { 
	let existeMascara; 
